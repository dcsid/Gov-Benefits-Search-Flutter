...
void main() {
  ...
  test('two simultaneous identical GETs result in ONE adapter call '
      '(dedup coalesces the second)', () async {
  ...
  test('POST requests are NOT deduped', () async {
    ...
    expect(
      calls,
      2,
      reason: 'POSTs are not deduped — they may have side effects',
    );
  });
}
