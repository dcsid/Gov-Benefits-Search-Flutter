...
void main() {
  group('IntakeService', () {
    test('interpret hits POST /intake/interpret', () async {
      final dio = _MockDio();
      when(() => dio.post<Object?>('/intake/interpret',
    ...
    test('probe hits POST /intake/probe with messages', () async {
      ...
      final captured = verify(() => dio.post<Object?>('/intake/probe',
