...
final programsListProvider = FutureProvider.family<List<Program>, String>((
  ref,
  jurisdictionCode,
) {
...
final sessionResultsProvider = FutureProvider.family<SessionResults, String>((
  ref,
  sessionId,
) {
...
final sessionPlanProvider = FutureProvider.family<SessionPlan, String>((
  ref,
  sessionId,
) {
...
final reviewTasksProvider = FutureProvider.family<List<ReviewTask>, String?>((
  ref,
  adminKey,
) {
  return ref.watch(adminServiceProvider).listReviewTasks(adminKey: adminKey);
});

/// POST /explorer/search. Re-runs whenever the request body changes.
final explorerSearchProvider =
    FutureProvider.family<ExplorerSearchResponse, ExplorerSearchRequest>((
      ref,
      body,
    ) {
...
class ChatTurnRequest {
  ...
  @override
  int get hashCode =>
      Object.hash(sessionId, userMessage, context, history.length);
}
